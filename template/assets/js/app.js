...
/***/ function(module, exports, __webpack_require__) {
	...
	var _secondaryNav = __webpack_require__(/*! ./modules/secondary-nav */ 25);
	
	var _secondaryNav2 = _interopRequireDefault(_secondaryNav);
	
	var _mainNav = __webpack_require__(/*! ./modules/main-nav */ 27);
	 ...
	 *
	 */
	__webpack_require__(/*! ../sass/app.scss */ 24);
	...
	var App = function () {
	  function App() {
	    ...
	    this.core = core;
	    this.secondaryNav = _secondaryNav2.default;
	    this.mainNav = _mainNav2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jquery = __webpack_require__(/*! jquery/dist/jquery */ 26);
...
/* 25 */
/*!********************************************!*\
  !*** ./source/js/modules/secondary-nav.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var execElement = function execElement($element) {
	    ...
	    $element.find('li').on({
	        mouseenter: function mouseenter(el) {
	            var idx = (0, _jquery2.default)(el.currentTarget).index();
	            $element.find('li').addClass('non-active-item');
	            (0, _jquery2.default)(el.currentTarget).removeClass('non-active-item').addClass('active-item');
	            (0, _jquery2.default)('.er-bg-container').css('zIndex', 1).find('img').eq(idx).addClass('active-item');
	        },
	        mouseleave: function mouseleave(el) {
	            $element.find('li').removeClass('non-active-item');
	            (0, _jquery2.default)(el.currentTarget).removeClass('active-item');
	            (0, _jquery2.default)('.er-bg-container').css('zIndex', 0).find('img').removeClass('active-item');
	        }
	    });
	};
